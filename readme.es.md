...
- [X] Proyecto de desafío - Depura una aplicación de consola de C\# usando
  Visual Studio Code
- [X] Trofeo - Depura aplicaciones de consola de C\#

![Depura aplicaciones de consola de C\#](./imgs/trophies/6.png)
